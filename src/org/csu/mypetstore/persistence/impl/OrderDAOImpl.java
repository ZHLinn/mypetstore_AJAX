...
public class OrderDAOImpl implements OrderDAO {
    ...
    public List<Order> getOrdersByUsername(String username) {
        ...
        try{
            ...
            PreparedStatement pStatement = connection.prepareStatement(GER_ORDER_BY_USERNAME);
    ...
    public void insertOrder(Order order) {
        java.sql.Date orderDate_sql;
        java.util.Date orderDate_util = order.getOrderDate();
        orderDate_sql = new java.sql.Date(orderDate_util.getTime());
        try{
            Connection connection = DBUtil.getConnection();
            ...
            pStatement.setDate(3, orderDate_sql);
